...
func IdentityReconciler(accountStore data.AccountStore, cfg *conf.Config, providerName string, providerUser *oauth.UserInfo, providerToken *oauth2.Token, linkableAccountID int) (*models.Account, error) {
